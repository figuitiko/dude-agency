...
class SubscribersCpt
{
    ...
    public static  function  getInstance(){
        if(self::$instance === null){
            self::$instance = new SubscribersCpt();
        }
        return self::$instance;
    }
    public function init(){
        add_action('init', array($this,'registerSubscribers' ));
...
$register_subscribers = SubscribersCpt::getInstance();
$register_subscribers->init();